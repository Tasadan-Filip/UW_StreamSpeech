...
class S2TDataConfig:
    ...
    def get_transforms(self, transform_type, split, is_train): # -> Any:
    ...
    def get_waveform_transforms(self, split, is_train): # -> Any:
        ...
    
    def get_dataset_transforms(self, split, is_train): # -> Any:
        ...
...
class MultitaskConfig:
    ...
    @property
    def first_pass_decoder_task_index(self): # -> int:
