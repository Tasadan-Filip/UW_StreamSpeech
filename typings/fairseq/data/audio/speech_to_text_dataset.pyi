...
class SpeechToTextDataset(FairseqDataset):
    ...
    def get_tokenized_tgt_text(self, index: Union[int, List[int]]): # -> str:
        ...
...
class TextTargetMultitaskData:
    ...
    def get_lang_tag_idx(self, lang: str, dictionary: Dictionary): # -> int:
        ...
    ...
    def get(self, sample_id, tgt_lang=...): # -> Tensor | IntTensor:
        ...
...
class SpeechToTextDatasetCreator:
    ...
    @classmethod
    def from_tsv(cls, root: str, cfg: S2TDataConfig, splits: str, tgt_dict, pre_tokenizer, bpe_tokenizer, is_train_split: bool, epoch: int, seed: int, n_frames_per_step: int = ..., speaker_to_id=..., multitask: Optional[Dict] = ...) -> SpeechToTextDataset:
        ...
