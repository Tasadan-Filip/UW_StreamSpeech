...
echo 'finish 1.learn_KM_clustering_model.sh' # .../datasets/cvss/cvss-c/es-en/<split>.km1000
...
echo 'finish 2.prep_cvss_c_multilingual_data.sh' # .../datasets/cvss/cvss-c/es-en
...
echo 'finish 3.prep_cvss_c_multitask_data.sh' # .../datasets/cvss/cvss-c/es-en/tgt_unigram6000

# Prepares the reference text from source text for the CVSS.
bash $PREPROCESS_ROOT/5.prep_cvss_c_ref_txt.sh $lang
echo 'finish 5.prep_cvss_c_ref_txt.sh' # --Reference text files for train, dev, and test: .../datasets/cvss/cvss-c/es-en/fbank2unit/<split>.txt; --Reference unit files: .../datasets/cvss/cvss-c/es-en/fbank2unit/<split>.unit --Source reference text: .../datasets/cvss/cvss-c/es-en/fbank2unit/<split>.src
...
echo 'finish 6.extract_simuleval_data.sh' # .../datasets/cvss/cvss-c/es-en/simuleval


# Prepares data for ASR multitask.
bash $PREPROCESS_ROOT/7.prep_cvss_c_multitask_asr_data.sh $lang
echo 'finish 7.prep_cvss_c_multitask_asr_data.sh'  # .../datasets/cvss/cvss-c/es-en/src_unigram6000
...
echo 'finish 8.prep_cvss_c_simuleval_unit.sh, 8.prep_cvss_c_simuleval_src.sh '  # --Source text files for SimulEval: .../datasets/cvss/cvss-c/es-en/simuleval/<split>/src.txt; --Unit text files for SimulEval:.../datasets/cvss/cvss-c/es-en/simuleval/<split>/unit.txt
